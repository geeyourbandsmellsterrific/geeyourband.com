...
`public/assets/images` is where the images uploaded on the CMS will be stored.
...
Files uploaded through the dashboard's media library will be stored in `src/assets/images` so that they can be accessed and optimised by Astro components if you wish.
